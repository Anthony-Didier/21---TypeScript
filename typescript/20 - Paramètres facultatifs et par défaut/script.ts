...
let result7 = buildName2("Bob", "Adams");
...
let result8 = buildName3("Bob");
console.log(result8); // Bob Smith // OK

let result9 = buildName3("Bob", undefined);
...
let result11 = buildName3("Bob", "Adams");
...
let result15 = buildName4(undefined, "Bob");
